...
//    private CustomContextMenu mCcMenu=null;
    ...
    public static CommonFileSelector newInstance(boolean debug,
                                                 boolean enableCreate, boolean fileOnly, boolean hideMp, boolean dir_only,
        ...
        bundle.putBoolean("directoryOnly", dir_only);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (mDialogSingleSelect) {
                    ...
                    if  (!mDialogIncludeMp) sl_array[0]=sl_array[0].replace(mp+"/","");
                    Log.v("","sel="+sl_array[0]+", mp="+mp+", incmp="+mDialogIncludeMp);
